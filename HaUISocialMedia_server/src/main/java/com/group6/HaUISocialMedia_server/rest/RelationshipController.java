...
import com.group6.HaUISocialMedia_server.service.RelationshipService;
...
public class RelationshipController {
    ...
    public ResponseEntity<List<UserDto>> pagingFriendsOfUser(@PathVariable("userId") UUID userId,
    ...
    public ResponseEntity<List<UserDto>> getMutualFriends(@PathVariable("userId1") UUID userId1,
            @PathVariable("userId2") UUID userId2) {
