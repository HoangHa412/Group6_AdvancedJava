...
import com.group6.HaUISocialMedia_server.entity.Notification;
import com.group6.HaUISocialMedia_server.entity.User;
import com.group6.HaUISocialMedia_server.repository.*;
import com.group6.HaUISocialMedia_server.service.NotificationService;
...
public class NotificationServiceImpl implements NotificationService {
    ...
    public Set<NotificationDto> getAllNotifications() {
        ...
        Set<NotificationDto> res = new TreeSet<>(
                (noti1, noti2) -> noti2.getCreateDate().compareTo(noti1.getCreateDate()));
    ...
    public NotificationDto save(NotificationDto notificationDto) {
        ...
        if (notificationDto.getNotificationType() != null)
            notification.setNotificationType(
                    notificationTypeRepository.findById(notificationDto.getNotificationType().getId()).orElse(null));
    ...
    public Set<NotificationDto> pagingNotification(SearchObject searchObject) {
        ...
        Set<NotificationDto> res = new TreeSet<>(
                (noti1, noti2) -> noti2.getCreateDate().compareTo(noti1.getCreateDate()));
        List<Notification> li = notificationRepository.pagingNotificationByUserId(currentUser.getId(),
