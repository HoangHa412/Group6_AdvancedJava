...
import com.group6.HaUISocialMedia_server.dto.NotificationTypeDto;
import com.group6.HaUISocialMedia_server.dto.SearchObject;
import com.group6.HaUISocialMedia_server.entity.NotificationType;
import com.group6.HaUISocialMedia_server.repository.NotificationTypeRepository;
import com.group6.HaUISocialMedia_server.service.NotificationTypeService;
...
public class NotificationTypeServiceImpl implements NotificationTypeService {
    ...
    public Set<NotificationTypeDto> findAll() {
        ...
        li.stream().map(x -> {
            ...
            notificationTypeDto.setNotificationsDto(
                    x.getNotifications().stream().map(NotificationDto::new).collect(Collectors.toSet()));
    ...
    public Set<NotificationTypeDto> getAnyNotificationType(SearchObject searchObject) {
        ...
        Page<NotificationType> li = notificationTypeRepository
                .findAll(PageRequest.of(searchObject.getPageIndex() - 1, searchObject.getPageSize()));
