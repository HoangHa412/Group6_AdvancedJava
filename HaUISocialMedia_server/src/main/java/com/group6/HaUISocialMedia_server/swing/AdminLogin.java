...
import com.group6.HaUISocialMedia_server.service.impl.UserServiceImp;
...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void pushData(List<UserDto> data) {
        ...
        try {
            ImageIcon avatarIcon = new ImageIcon(new URL(
                    "https://firebasestorage.googleapis.com/v0/b/minishop-29721.appspot.com/o/files%2F80c546ef-94b7-4946-99b0-b8e0847ce686?alt=media&token=db60cdd2-995f-47ea-88bc-aaf216219997"));
                ...
                if (row >= 0) {
                    try {
                        ...
                        if (userDto != null) {
                            ...
                            JOptionPane.showMessageDialog(null, "Người dùng không tồn tại", "Error",
    ...
    private void initComponents() {
        ...
        datatable.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "ID", "Code", "Username", "Email", "First Name", "Last Name", "Address", "Birth day", "Gender",
                        "Phone", "Status"
                }) {
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel3Layout.createSequentialGroup()
                                                .addGap(61, 61, 61)
                                                .addComponent(logo, javax.swing.GroupLayout.PREFERRED_SIZE, 162,
        ...
        jPanel3Layout.setVerticalGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel3Layout
                                                        ...
                                                        .addGroup(jPanel3Layout.createSequentialGroup()
                                                                ...
                                                                .addComponent(logo,
                                                                        ...
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                                .addGap(39, 39, 39)
                                                .addComponent(ListBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 41,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(34, 34, 34)
                                ...
                                .addGap(4, 4, 4)
                                .addComponent(ExitBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 41,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(20, 20, 20)));
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout
                                                ...
                                                .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 34,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(searchField, javax.swing.GroupLayout.PREFERRED_SIZE, 28,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
