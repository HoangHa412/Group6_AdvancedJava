...
import com.group6.HaUISocialMedia_server.entity.Relationship;
...
public interface RelationshipRepository extends JpaRepository<Relationship, UUID> {
    ...
    List<Relationship> findAllSentFriendRequestRelationship(@Param("currentUserId") UUID currentUserId,
            Pageable pageable);
    ...
    List<Relationship> getRelationshipBetweenCurrentUserAndViewingUser(@Param("currentUserId") UUID currentUserId,
